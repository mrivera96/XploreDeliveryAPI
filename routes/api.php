...
Route::group(['prefix' => 'admins'], function () {
    ...
    Route::group(['middleware' => 'auth:api'], function () {
        ...
        Route::group(['prefix' => 'orders'], function () {
            ...
            Route::post('changeAddress', 'DeliveriesController@changeDestinationAddress');
        });
        ...
        Route::group(['prefix' => 'reports'], function () {
            ...
            Route::post('consolidatedOrdersByDriver', 'DeliveriesController@reportConsolidatedOrdersByDriver');
            Route::post('billingReport', 'BillingDataController@billingReport');
        });
...
Route::group(['middleware' => 'auth:api'], function () {
    Route::group(['prefix' => 'customers'], function () {
        ...
        Route::group(['prefix' => 'paymentMethods'], function () {
            ...
            Route::post('saveFailTransaction', 'PaymentMethodsController@saveFailTransaction');
        });
...
Route::get('testReplace','DeliveriesController@characterReplace');
